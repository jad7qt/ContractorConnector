          ...
          <div class="modal-content">
            ...
            <form name="rateForm" action="profile" method="post">
              <div class="modal-body">
                ...
                <div class="row mb-3 mx-3">
                  Phone Number:
                  <input type="tel" id="phoneNum" class="form-control" name="phoneNum"
                  ...
                  <div class="modal-body">
                    <div class="row mb-3 mx-3">
                      ...
                      <input type="number" class="form-control" name="rating" min=0 max=5 step=0.1
                        value="<?php if ($hasRated)
                          echo $ratingGiven['Rating'] ?>" required />
                      </div>
                      <div class="row mb-3 mx-3">
                        Comment:
                        <input type="text" class="form-control" name="comment" maxlength=65
                          value="<?php if ($hasRated)
                          echo $ratingGiven['Comment'] ?>" required />
                      </div>
                      <input type="hidden" name="TechID" value=<?php echo $_GET['id']; ?> />
                    <input type="hidden" name="CustID" value=<?php echo $_SESSION['UserID']; ?> />
                  </div>
