<header>
    <link rel="stylesheet" href="<?php echo CSS_PATH; ?>header.css">
		<div class="logo-container">
      		...
      		<Button id="CCbutton" onclick="window.location.href='homepage'">
      <h1 class="site-title">ContractorConnector</h1>
    	...
    	<h2 id="name" class="welcome-message">Welcome <?php echo $_SESSION['FirstName']?> (<?php echo $_SESSION['Type']?>)
		  ...
		  <button class="logout-button" onclick="window.location.href='logout'">
  			<img src="<?php echo IMG_PATH; ?>icons/logout.png" alt="Logout" style="filter: invert(1); max-width: 20px; max-height: 20px;">
			</button>
